...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\EpsiWeb\OneDrive\Escritorio\epsiweb\web_alejandro\conteo\flask-server'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\EpsiWeb\OneDrive\Escritorio\epsiweb\web_alejandro\conteo\flask-server\Scripts\deactivate.nu'
